    ...
    <nav id="bg-white" class="navbar-custom">
        ...
        <ul class="pt-2 pb-2 list-inline float-right mb-0">
            <li class="list-inline-item dropdown notification-list nav-user">
                ...
                <button id="bg-blue" class="btn btn-sm btn-primary dropdown-toggle mt-3 mb-3 mr-4 ml-5 waves-effect text-uppercase" data-toggle="dropdown"> {{Auth::guard('client')->user()->name}} </button>
