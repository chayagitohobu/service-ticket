                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card m-b-30 p-4">
                                    <div class="card-body">
                                        <form class="" action="{{route('operator.update')}}" method="POST">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group col-lg-12">
                                                        <label>Nama</label>
                                                        <input name="name" value="{{$operator->name}}" type="text" class="form-control" required placeholder="Type something"/>
                                                    </div>
                                                    <div class="form-group col-lg-12">
                                                        <label>No. Telp</label>
