                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="card m-b-30 card-body text-center">
                                            ...
                                            <br>
                                            <a href="{{route('operator.tiket.create')}}" class="btn btn-primary waves-effect waves-light">Buat tiket baru</a>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="card m-b-30 card-body text-center">
                                            ...
                                            <br>
                                            <a href="{{route('operator.tiket.status_filter', $status = 'Balasan client')}}" class="btn btn-primary waves-effect waves-light">Lihat tiket</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card m-b-30 card-body text-center">
                                            ...
                                            <br>
                                            <a href="{{route('operator.tiket.status_filter', $status = 'Buka')}}" class="btn btn-primary waves-effect waves-light">Lihat tiket</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card m-b-30 card-body text-center">
                                            ...
                                            <br>
                                            <a href="{{route('operator.tiket.status_filter', $status = 'Tutup')}}" class="btn btn-primary waves-effect waves-light">lihat tiket</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
