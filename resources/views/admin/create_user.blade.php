                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            <div class="form-group col-lg-6">
                                                                <label>Email</label>
                                                                <input required aria-required="true" name="email" type="text" class="form-control"  placeholder="Type something"/>
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label>Divisi</label>
                                                            ...
                                                            <div class="form-group col-lg-6">
                                                                <label>Nama </label>
                                                                <input required aria-required="true" name="name" type="text" class="form-control"   placeholder="Type something"/>
                                                            </div>
                                                            
                                                            <div class="form-group col-lg-6">
                                                                <label>No. Telp</label>
                                                                <input name="phone" type="number" class="form-control"  placeholder="Type something"/>
                                                            </div>
                                                        </div>
                                                        
                                                    </div>
                                                    <div class="col-lg-4 mt-3 text-left">
                                                        <button type="submit" class="btn btn-primary btn-lg pr-4 pl-4 mt-2 waves-effect waves-light"><i class="mdi mdi-pencil-outline mr-3"></i>Buat User</button>
