        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="p-2">
                            <h4 class="text-muted float-right font-18 mt-4">User Sign In</h4>
                            <div>
                                <a href="index.html" class="logo logo-admin"><img src=" {{asset('assets/images/logo_dark.png')}}" height="40" alt="logo"></a>
                            </div>
                        </div>
                        
                        <div class="p-2">
                            @include('inc.messages')
                            <form class="form-horizontal m-t-20" method="POST" action="{{ route('user.loginSubmit') }}">
                                @csrf    
